...
},
{
  ...
  brand: "Farmer",
  name: "Bay Leaf",
  images: [process.env.PUBLIC_URL +"/Images/bay.webp", process.env.PUBLIC_URL +"/Images/bayimg2.webp"],
  itemPrice: 15,
},
{
  id: 602,
  brand: "Farmer",
  name: "Black Pepper",
  images: [process.env.PUBLIC_URL +"/Images/blackpepper.webp", process.env.PUBLIC_URL +"/Images/blackpepperimg2.webp"],
  itemPrice: 23,
},
{
  id: 603,
...
},
{
  ...
  brand: "Farmer",
  name: "Clove",
  images: [process.env.PUBLIC_URL +"/Images/clove.jpeg", process.env.PUBLIC_URL +"/Images/cloveimg2.jpg"],
  itemPrice: 42,
},
{
  id: 605,
  brand: "Farmer",
  name: "Cardamom",
  images: [process.env.PUBLIC_URL +"/Images/cardamom.jpg", process.env.PUBLIC_URL +"/Images/cardamaomimg2.jpeg"],
  itemPrice: 55,
},
{
  id: 606,
  brand: "Farmer",
  name: "Star Anise",
  images: [process.env.PUBLIC_URL +"/Images/staranise.webp", process.env.PUBLIC_URL +"/Images/staraniseimg2.webp"],
  itemPrice: 26,
},
{
  id: 607,
  brand: "Farmer",
  name: "Fenugreek",
  images: [process.env.PUBLIC_URL +"/Images/fenugreek.webp", process.env.PUBLIC_URL +"/Images/fenugreekimg2.jpg"],
  itemPrice: 60,
},
{
  id: 608,
  brand: "Farmer",
  name: "Mustard Seeds",
  images: [process.env.PUBLIC_URL +"/Images/mustard.cms", process.env.PUBLIC_URL +"/Images/mustardimg2.jpg"],
  itemPrice: 14,
},
{
  id: 609,
  brand: "Farmer",
  name: "Fennel Seeds",
  images: [process.env.PUBLIC_URL +"/Images/fennel.webp", process.env.PUBLIC_URL +"/Images/fennelimg2.jpg"],
  itemPrice: 38,
},
{
  id: 610,
...
},
{
  ...
  brand: "Farmer",
  name: "Cumin",
  images: [process.env.PUBLIC_URL +"/Images/cumin.jpg", process.env.PUBLIC_URL +"/Images/cuminimg2.webp"],
  itemPrice: 25,
},
];
...
function SpicesContent() {
  ...
  const handleAddToCart = () => {
    ...
    alert(
      `${quantity} unit(s) of 100 grams x ${selected.name} added/updated in cart.`
    );
    setSelected(null);
    setQuantity(1);
    setCurrentRating(0);
  ...
  const sortedSpices = useMemo(() => {
    if (sortOption === "default") return [...SPICE];
    const sorted = [...SPICE];
        ...
        >
          {sortedSpices.map((spice) => (
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === "Enter" && openModal(spice)}
              onClick={() => openModal(spice)}
              style={{
                borderRadius: "20px",
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  fontSize: "24px",
                  color: wishlist.includes(spice.id) ? "#8dc63f" : "#999",
                  cursor: "pointer",
                  display: "flex",
                  alignItems: "center",
        ...
        {selected && (
          ...
          >
            ...
            >
              ...
              >
                Quantity: {quantity} unit(s) of 100 grams
              </div>
