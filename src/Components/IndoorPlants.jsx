...
const PLANTS = [
  {
    ...
    images: ["/Images/pearls.webp", "/Images/pearlsimg2.webp"],
    itemPrice: 90,
  },
  {
    id: 1001,
    brand: "Farmer",
    name: "Fittonia",
    images: ["/Images/fittonia.webp", "/Images/fittoniaimg2.jpg"],
    itemPrice: 160,
  },
  {
    id: 1002,
  ...
  },
  {
    ...
    images: ["/Images/moneyplant.webp", "/Images/money-plant.webp"],
    itemPrice: 125,
  },
  {
    id: 1004,
    ...
    images: ["/Images/adrenium.webp", "/Images/rosette.jpg"],
    itemPrice: 150,
  },
  {
    id: 1005,
    ...
    images: ["/Images/hearts.png", "/Images/hearts.jpeg"],
    itemPrice: 80,
  },
  {
    id: 1006,
    ...
    images: ["/Images/bunnyears.jpg", "/Images/bunnyearsimg2.jpg"],
    itemPrice: 100,
  },
  {
    id: 1007,
    brand: "Farmer",
    name: "Ferns",
    images: ["/Images/ferns.jpg", "/Images/ferns.webp"],
    itemPrice: 120,
  },
  {
    id: 1008,
    brand: "Farmer",
    name: "Ficus Bonsai",
    images: ["/Images/ficusbonsai.jpg", "/Images/ficusimg2.jpg"],
    itemPrice: 400,
  },
];
...
function IndoorPlantsContent() {
  ...
  const toggleWishlist = (plantsId) => {
    setWishlist((prev) =>
      prev.includes(plantsId)
        ? prev.filter((id) => id !== plantsId)
        : [...prev, plantsId]
    );
  };

  const openModal = (plants) => {
    setSelected(plants);
  ...
  return (
    ...
    <Navbar />
      ...
      >
        ...
        >
          {sortedPlants.map((plants) => (
            <div
              key={plants.id}
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === "Enter" && openModal(plants)}
              onClick={() => openModal(plants)}
              style={{
                borderRadius: "20px",
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  fontSize: "24px",
                  color: wishlist.includes(plants.id) ? "#8dc63f" : "#999",
                  cursor: "pointer",
                  display: "flex",
                  alignItems: "center",
