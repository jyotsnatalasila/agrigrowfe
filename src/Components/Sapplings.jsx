...
function SapplingContent() {
  ...
  // Wishlist toggle uses context functions
  ...
  // Sort corn products according to selected option
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  fontSize: "24px",
                  color: isInWishlist(corn.id) ? "#8dc63f" : "#999",
                  cursor: "pointer",
                  display: "flex",
                  alignItems: "center",
              ...
              >
                ...
                {selectedImageIdx < selected.images.length - 1 && (
                  <button
                    ...
                    onClick={() =>
                      setSelectedImageIdx(
                        Math.min(selectedImageIdx + 1, selected.images.length - 1)
                      )
                    }
...
export default function Sappling() {
  return <SapplingContent />;
}
