...
function NutsContent() {
  ...
  const handleAddToCart = () => {
    ...
    alert(
      `${quantity} unit(s) of 250 grams x ${selected.name} added/updated in cart.`
    );
    setSelected(null);
    setQuantity(1);
    setCurrentRating(0);
  ...
  const sortedNuts = useMemo(() => {
    if (sortOption === "default") return [...NUTS];
    const sorted = [...NUTS];
        ...
        >
          {sortedNuts.map((nut) => (
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => e.key === "Enter" && openModal(nut)}
              onClick={() => openModal(nut)}
              style={{
                borderRadius: "20px",
                background: cardBg,
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  fontSize: "24px",
                  color: wishlist.includes(nut.id) ? "#8dc63f" : "#999",
                  cursor: "pointer",
                  display: "flex",
                  alignItems: "center",
        ...
        {selected && (
          ...
          >
            ...
            >
              ...
              >
                Quantity: {quantity} unit(s) of 250 grams
              </div>
